...
import com.wise.groupware.repository.ArticleCommentRepository;
...
class ArticleCommentServiceTest {
    ...
    @DisplayName("댓글 저장을 시도한 게시글이 없으면, 경고 로그를 찍고 아무것도 안한다.")
    @Test
    void givenNonexistentArticle_whenUpdatingArticleComment_thenLogsWarningAndDoesNothing() {
        // Given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
